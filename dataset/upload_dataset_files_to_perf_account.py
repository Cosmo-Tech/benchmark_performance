...
def upload_files(dataset_id: str, scenario_directory: str):
    ...
    for dataset_csv_file in os.listdir(f"{PATH.DATA}/{scenario_directory}/dataset"):
        ...
        with open(f"{PATH.DATA}/{scenario_directory}/dataset/{dataset_csv_file}", "rb") as data:
